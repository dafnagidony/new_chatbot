...
/**
 * @function Disable external user 
 * @returns {object} Returns a promise.
 * @public
 */
module.exports.disableUser = function enableUser(obToken, userId) {
  var options = {
    url: constants.AMPLIFY_INTERNAL_API_URL + `/users/${userId}/disable`,
    headers: obToken,
    method: 'PUT'
  }
  return requestHelper(options);
