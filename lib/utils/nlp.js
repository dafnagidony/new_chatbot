...
function selectAction(subj, sessionObj, userModel) {
...
module.exports.nlpResponse = function nlpResponse(str, sessionObj, userModel) {
  var senderID = sessionObj.senderID;
  ...
  if (action) {
    action(subject, sessionObj, userModel);
  } else {
